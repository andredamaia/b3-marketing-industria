<header class="wow fadeInDown" data-wow-delay=".4s">
    <div class="container">
        <div class="row d-flex align-items-center" style="justify-content: space-between;">
            <div class="col-6 col-md-4 col-xl-4">
                <div class="logo">
                    <a href="<?php echo $pageurl; ?>">
                        <svg x="0px" y="0px" viewBox="0 0 752.34 138.43" style="enable-background:new 0 0 752.34 138.43;">
                            <path fill="#FFE00A" class="st0" d="M140.88,49.97l-20.14-34.89c-2.73-4.73-7.81-7.66-13.27-7.66h-43.2c-6.45,0-11.96,4.01-14.22,9.66l-1.1-0.63
                            ...
                            <g>
                                <g>
                                    <g>
                                        <path class="st1" fill="#1E1E1C" d="M213.75,37.19c12.86,0,23.49,5.8,23.49,18.37c0,5.61-2.51,10.83-8.99,13.82c8.6,3.09,12.18,11.8,10.73,19.62
                                        ...
                                        <path class="st1" fill="#1E1E1C" d="M261.99,76.34V64.06h9.38c4.93,0,12.28-0.39,12.37-6.67c0-2.9-1.93-7.64-11.99-7.64
                                        ...
                                        <path class="st1" fill="#1E1E1C" d="M404.1,104.86h-13.54V73.63c0-7.64-3.38-10.15-7.35-10.15c-6.77,0-9.18,4.45-9.18,10.54v30.84H360.5V73.92
                                        ...
                                        <path class="st1" fill="#1E1E1C" d="M454.28,94.8c0,6.09,1.35,7.44,3,8.03v2.03h-14.6c-0.77-2.42-0.97-3.19-1.26-6.09
                                        ...
                                        <path class="st1" fill="#1E1E1C" d="M462.4,53.43h12.95v8.89h0.19c2.8-5.22,5.89-10.25,14.11-10.25c0.87,0,1.74,0.1,2.61,0.19V66
                                            c-1.16-0.19-2.61-0.19-3.87-0.19c-10.54,0-12.47,6.57-12.47,12.28v26.78H462.4V53.43z"/>
                                        <path class="st1" fill="#1E1E1C" d="M508.7,104.86h-13.54V35.45h13.54v37.51l17.01-19.53h16.63l-18.17,19.92l18.66,31.52h-16.24l-12.28-22.04
                                            l-5.61,5.8V104.86z"/>
                                        <path class="st1" fill="#1E1E1C" d="M586.91,89.78c-3.58,12.37-13.82,16.44-22.62,16.44c-14.5,0-25.62-6.96-25.62-28.13
                                        ...
                                        <path class="st1" fill="#1E1E1C" d="M607.8,53.43h8.41v9.67h-8.41v27.94c0,3,0.09,4.16,5.6,4.16c0.87,0,1.84-0.09,2.8-0.19v10.25
                                            c-2.13,0.09-4.25,0.19-6.38,0.19h-1.74c-11.7,0-13.83-4.45-13.83-11.12V63.1h-6.96v-9.67h6.96V39.51h13.54V53.43z"/>
                                        <path class="st1" fill="#1E1E1C" d="M634.87,47.34h-13.54V34.77h13.54V47.34z M634.87,53.43v51.43h-13.54V53.43H634.87z"/>
                                        <path class="st1" fill="#1E1E1C" d="M690.45,104.86h-13.53V73.63c0-3.77-0.19-10.15-8.8-10.15c-5.99,0-10.64,4.06-10.64,11.89v29.49h-13.53
                                            V53.43h12.95v7.54h0.19c1.84-3.09,5.7-8.89,15.47-8.89c10.06,0,17.88,5.9,17.88,17.21V104.86z"/>
                                        <path class="st1" fill="#1E1E1C" d="M746.33,53.43v48.73c0,8.89-0.68,23.68-26.01,23.68c-10.63,0-21.85-4.54-22.43-15.47h14.69
            ...
            <div class="col-6 d-block d-md-block d-xl-none" style="text-align: right;">
...
<div class="mobile-menu-open wow fadeInDown" data-wow-delay=".6s">
    <lord-icon 
        class="open-menu"
        src="https://cdn.lordicon.com/clgqklvt.json"
